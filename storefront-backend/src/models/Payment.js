...
const paymentSchema = new mongoose.Schema(
  {
    ...
    // Stored for audit purposes only — verification always re-derives
    // the HMAC from the key secret server-side, it never trusts or
    // re-uses a previously-stored signature. select: false keeps it out
    // of normal queries/JSON responses by default.
